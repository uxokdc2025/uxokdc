...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:rgba(0,0,0,.55);width:100%;height:100%;min-height:120px}' +
    ...
    ':host([data-dark]){color:rgba(242,241,238,.8)}' +
    ':host([data-dark]) .frame{background:rgba(242,241,238,.08)}' +
    ':host([data-dark]) .ring{border-color:rgba(242,241,238,.4)}' +
    ':host([data-dark]) .empty .sub u{text-decoration-color:rgba(242,241,238,.4)}' +
    ':host([data-dark]) .empty:hover .sub u{color:rgba(242,241,238,.95)}';
